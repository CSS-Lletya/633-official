...
public class BankInterfacePlugin implements RSInterfaceListener {

    @Override
    public void execute(Player player, int interfaceId, int componentId, int option, byte slotId, int slotId2) throws Exception {
        if (interfaceId == 11) {
            if (componentId == 17) {
                if (option == 11)
                	...
                	player.getPackets().sendInputIntegerScript("How many would you like to deposit?", new IntegerInputAction() {
						@Override
