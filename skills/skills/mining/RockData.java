...
public enum RockData {
	...
	LRC_COAL(new int[] {5999}, 453, 30, 50.0, 12, 3, 500, 0.2),
	LRC_GOLD(new int[] {45076}, 444, 40, 65.0, 180, 3, 500, 0.1),
	LRC_MINERALS(new int[] {45076}, 15263, 73,25, 25, 3, 500, 0.6), //faster mining instead of 5-28 lengthy rng. change on demand.
	;
	/**
