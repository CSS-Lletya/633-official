...
@ObjectSignature(objectId = { 16149, 16080, 16148, 16118, 16154, 16078, 16081, 16114, 16115, 16049, 16112, 16048, 16150, 16082,
		16116, 16050, 16043, 16044, 16065, 16066, 16089, 16090, 16124, 16123, 16135, 16077, 16047, 16146 }, name = {})
	...
	public void execute(Player player, GameObject object, int optionId) throws Exception {
		int id = object.getId();
         ...
         if (id == 16135) {
             ...
             player.dialogue(d -> d.item(995, 2000, "...Congratulations adventurer, you have been deemed worthy of this reward."));
         ...
         if (id == 16118) {
             ...
             player.dialogue(d -> d.item(995, 5000, "...Congratulations adventurer, you have been deemed worthy of this reward."));
             player.getDetails().getStrongholdLevels().getAndIncrement();
             return;
         }
         if (id == 16047) {
					...
					option(
						"Colorful ones", () -> {
						 player.getInventory().addItemDrop(9005, 1);
				             player.dialogue(d -> d.item(9005, 1, "...Congratulations adventurer, you have been deemed worthy of this reward."));
                         player.getDetails().getStrongholdLevels().getAndIncrement();
                         player.getAudioManager().sendSound(Sounds.FINDING_TREASURE);
					},  "Combat ones", () -> {
						 player.getAudioManager().sendSound(Sounds.FINDING_TREASURE);
						player.getInventory().addItemDrop(9006, 1);
				             player.dialogue(d -> d.item(9006, 1, "...Congratulations adventurer, you have been deemed worthy of this reward."));
					});
				}
			});
         }
