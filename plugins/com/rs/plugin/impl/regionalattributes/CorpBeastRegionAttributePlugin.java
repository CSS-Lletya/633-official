...
@RegionAttributeSignature(forceMultiRegions = {}, alias="Corporeal_beast")
public class CorpBeastRegionAttributePlugin implements RegionAttributeListener {

	@Override
	public boolean withinMultiZonedBoundaries(WorldTile tile) {
		int destX = tile.getX();
		int destY = tile.getY();
		return destX >= 2970 && destX <= 3000 && destY >= 4365 && destY <= 4400;
	}
}