...
public class OysterItemPlugin extends InventoryListener {
	...
	public void execute(Player player, Item item, int slotId, int option) {
		player.getInventory().replaceItems(new Item(ItemNames.OYSTER_407), (RandomUtility.percentageChance(50) ? 
						  new Item(ItemNames.OYSTER_PEARL_411)
						: RandomUtility.percentageChance(5) ? new Item(ItemNames.OYSTER_PEARLS_413) : new Item(ItemNames.EMPTY_OYSTER_409)));
	}
}