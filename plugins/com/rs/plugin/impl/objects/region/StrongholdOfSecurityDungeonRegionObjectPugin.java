	...
	public void execute(Player player, GameObject object, int optionId) throws Exception {
		...
		if (id == 16135) {
			...
			player.dialog(new DialogueEventListener(player) {
				...
				public void start() {
					...
					mes("...Congratulations adventurer, you have been deemed worthy of this reward.<br>You have also unlocked the Flap emote!");
					player.task(1, p -> {
		...
		if (id == 16077) {
			...
			player.dialog(new DialogueEventListener(player) {
				...
				public void start() {
					mes("The box hinges creak and appear to be forming audible words....");
					mes("...Congratulations adventurer, you have been deemed worthy of this reward.<br>You have also unlocked the Slap head emote!");
					player.task(1, p -> {
						player.getDetails().getStrongholdLevels().getAndIncrement();
		...
		if (id == 16118) {
			...
			player.dialog(new DialogueEventListener(player) {
				...
				public void start() {
					mes("The box hinges creak and appear to be forming audible words....");
					mes("...Congratulations adventurer, you have been deemed worthy of this reward.<br>You have also unlocked the Idea emote!");
					player.task(1, p -> {
						player.getDetails().getStrongholdLevels().getAndIncrement();
				...
				public void start() {
					option("Colorful ones", () -> {
						...
						player.dialog(new DialogueEventListener(player) {
							...
							public void start() {
								mes("The box hinges creak and appear to be forming audible words....");
								mes("...Congratulations adventurer, you have been deemed worthy of this reward.<br>You have also unlocked the Stomp emote!");
								player.task(1, p -> {
									player.getDetails().getStrongholdLevels().getAndIncrement();
