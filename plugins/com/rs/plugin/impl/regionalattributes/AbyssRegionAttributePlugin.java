...
@RegionAttributeSignature(forceMultiRegions = {}, alias = "Abyss")
public class AbyssRegionAttributePlugin implements RegionAttributeListener {

	@Override
	public boolean withinMultiZonedBoundaries(Entity tile) {
		int destX = tile.getX();
		int destY = tile.getY();
		return destX >= 3002 && destX <= 3066 && destY >= 4804 && destY <= 4866;
	}
}